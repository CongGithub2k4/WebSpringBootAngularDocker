...
public class BookingController {
	...
	// http://localhost:8080/booking/admin/get-all?status=0&page=1
	// Gộp hết vào @GetMapping("/admin/get-booking-by-stauts-userphone-tourid/{sdt}/{id}")
	//	public ResponseEntity<Map<String, Object>> adminGetBookingsByStatusUserSDTandTourID()
	/*@GetMapping("/admin/get-all")
	public ResponseEntity<Map<String, Object>> adminGetAllBookingsByStatus(
		@RequestParam Integer status,
		@RequestParam(defaultValue = "1") int page
	) {
		try {
			...
			Map<String, Object> bookings = bookingService.adminGetAllBooking(status,page);
			return ResponseEntity.ok(bookings);
		} catch (RuntimeException ex) {
			Map<String, Object> error = new HashMap<>();
			error.put("message", "Bạn chưa đăng nhập hoặc lỗi thông tin");
	...
	// http://localhost:8080/booking/admin/get-booking-by-status-userphone?status=0&sdt=01234567891&page=1
	// Gộp hết vào @GetMapping("/admin/get-booking-by-stauts-userphone-tourid/{sdt}/{id}")
	//	public ResponseEntity<Map<String, Object>> adminGetBookingsByStatusUserSDTandTourID()
	/*@GetMapping("/admin/get-booking-by-userphone")
	public ResponseEntity<Map<String, Object>> adminGetBookingsByStatusUserSDT(
		@RequestParam Integer status,
		...
		try {
			...
			Map<String, Object> bookings = bookingService.adminGetAllBookingByUserSDT(status,sdt, page);
			return ResponseEntity.ok(bookings);
		} catch (RuntimeException ex) {
			Map<String, Object> error = new HashMap<>();
			error.put("message", "Bạn chưa đăng nhập hoặc lỗi thông tin");
	...
	// http://localhost:8080/booking/admin/get-booking-by-status-tourid?status=0&tour_id=1&page=1
	// Gộp hết vào @GetMapping("/admin/get-booking-by-stauts-userphone-tourid/{sdt}/{id}")
	//	public ResponseEntity<Map<String, Object>> adminGetBookingsByStatusUserSDTandTourID()
	/*@GetMapping("/admin/get-booking-by-tourid")
	public ResponseEntity<Map<String, Object>> adminGetBookingsByStatusTourID(
		@RequestParam Integer status,
		...
		try {
			...
			Map<String, Object> bookings = bookingService.adminGetAllBookingByTourID(status,tour_id, page);
			return ResponseEntity.ok(bookings);
		} catch (RuntimeException ex) {
			Map<String, Object> error = new HashMap<>();
			error.put("message", "Bạn chưa đăng nhập hoặc lỗi thông tin");
