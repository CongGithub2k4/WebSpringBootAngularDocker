...
@Component({
  selector: 'app-tour-card-done',
  imports: [CommonModule],
  templateUrl: './user-booking-moved.component.html',
  styleUrl: './user-booking-moved.component.css'
})
export class TourCardDoneComponent {
  ...
  goToDetail() {
    this.router.navigate(['tourdetail/moved'], {
      queryParams: {
