...
@Component({
  selector: 'app-tour-detail-canceled',
  imports: [CommonModule, FormsModule, HeaderComponent],
  templateUrl: './tour-detail-canceled.component.html',
  styleUrl: './tour-detail-canceled.component.css'
})
export class TourDetailCanceledComponent {
  tour?: Tour;
  booking?: Booking;
  bookingId !: number;
  errorMessage: string = '';
